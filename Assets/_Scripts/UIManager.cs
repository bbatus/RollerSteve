...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField] Text CreamAmountText;
    [SerializeField] Text ConeAmountText;
    ...
    private void Start()
    {
        ...
        CreamAmountTextChange(0);
        ConeAmountTextChange(0);
    ...
    public void CreamAmountTextChange(int amount)
    {
        CreamAmountText.text = amount.ToString();
    }
    public void ConeAmountTextChange(int amount)
    {
        ConeAmountText.text = amount.ToString();
    }
    /*  public void FindPos()
      {
